...
if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"), console.log(responsiveVoice); else var ResponsiveVoice = function () {
        ...
        if (a.rvsMapped) {
            ...
            if (b.length > a.CHARACTER_LIMIT) {
                for (var f = b; f.length > a.CHARACTER_LIMIT;) {
                    var g = f.search(/([:!\u00a1?\u00bf;\(\)\[\]\u2014\u00ab\u00bb\n]+|\.[^0-9]+)/), e = "";
                    if (-1 ==
                        g || g >= a.CHARACTER_LIMIT) g = f.search(/,[^0-9]+/);
                    -1 == g && -1 == f.search(" ") && (g = 99);
            ...
            !0 === g.deprecated && console.warn("ResponsiveVoice: Voice " + g.name +
    ...
    a.startTimeout = function (b, c) {
        ...
        0 >= d || (a.timeoutId = setTimeout(c, a.getEstimatedTimeLength(b, d)), a.log("Timeout ID: " +
            a.timeoutId))
    };
    ...
    a.fallback_finishPart = function (b) {
        a.isFallbackAudioPlaying() ? (a.checkAndCancelTimeout(), a.timeoutId = setTimeout(a.fallback_finishPart, 1E3 * (a.fallback_audio.duration - a.fallback_audio.currentTime))) : (a.checkAndCancelTimeout(), a.fallbackChunkIndex < a.fallbackChunks.length - 1 ? (a.fallbackChunkIndex++, a.fallback_startPart()) :
            a.speech_onend())
    };
    a.cancel = function () {
        a.checkAndCancelTimeout();
    ...
    a.Dispatch = function (b) {
        ...
        a.hasOwnProperty(h) || (a[k] =
            10, a[h] = setInterval(function () {
            --a[k];
    ...
    a.clickEvent = function () {
        ...
        a.is_android &&
        !a.android_initialized && (a.click_event_detected = !0, a.initFallbackPool());
    ...
    a.initFallbackPool = function () {
        if ((a.is_android || a.iOS) && !a.click_event_detected) a.allowSpeechDiv || (a.allowSpeechDiv_appearances = null == a.allowSpeechDiv_appearances ? 1 : ++a.allowSpeechDiv_appearances, 2 < a.allowSpeechDiv_appearances ? console.log("ResponsiveVoice: Speech not allowed by user") : (a.allowSpeechDiv = document.createElement("div"), document.body.appendChild(a.allowSpeechDiv), a.allowSpeechDiv.style.cssText = "left: 0px; bottom: 0px; width: 100vw; height:auto; background-color: #fee891; position: fixed;",
            a.allowSpeechDiv.innerHTML = '<p style="text-align:center">This page wants to use speech.  <button onclick="responsiveVoice.allowSpeechClicked(true);">Allow</button>&nbsp;<button onclick="responsiveVoice.allowSpeechClicked(false);">Deny</button></p>')); else if (!a.fallback_audiopool || 0 == a.fallback_audiopool.length) {
            for (var b = 0; 10 > b; b++) {
                ...
                a.iOS &&
                (d.src = "", d.load(), 9 == c && (a.log("iOS audio initialized"), a.iOS_initialized = !0));
    ...
    a.allowSpeechClicked = function (b) {
        ...
        b && (a.clickEvent(), a.scheduledSpeak && (a.speak(a.scheduledSpeak.text, a.scheduledSpeak.voicename, a.scheduledSpeak.parameters), a.scheduledSpeak = null))
    };
    ...
    a.setVolume = function (b) {
        ...
        a.utterances.length; c++) a.utterances[c].volume = b
    };
